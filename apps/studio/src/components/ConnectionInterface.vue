        ...
        <div class="small-wrap expand">
          <div class="card-flat padding">
            <div class="flex flex-between">
              <h3 class="card-title" v-if="!pageTitle">新添连接</h3>
            ...
            <form @action="submit" v-if="config">
              <div class="form-group">
                ...
                <select name="connectionType" class="form-control custom-select" v-model="config.connectionType" id="connection-select">
                  <option disabled value="null">请选择一个连接类型...</option>
              ...
              <div v-if="config.connectionType">
                ...
                <div v-if="config.connectionType !== 'other'" class="test-connect row flex-middle">
                  ...
                  <div class="btn-group">
                    <button :disabled="testing" class="btn btn-flat" type="button" @click.prevent="testConnection">测试</button>
                    <button :disabled="testing" class="btn btn-primary" type="submit" @click.prevent="submit">连接</button>
                  </div>
                </div>
  ...
  export default {
    ...
    methods: {
      ...
      async duplicate(config) {
        ...
        duplicateConfig.name = '复制 ' + duplicateConfig.name
