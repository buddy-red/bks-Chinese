<template>
  <div class="shortcuts">
    ...
    <div class="shortcut-item">
      <div>运行</div>
      <div class="shortcut" v-if="$config.isMac"><span>⌘</span><span>回车</span></div>
      <div class="shortcut" v-else><span>Ctrl</span><span>回车</span></div>
    </div>
    <div class="shortcut-item">
      <div>运行当前</div>
      <div class="shortcut" v-if="$config.isMac"><span>⌘</span><span>⇧</span><span>回车</span></div>
      <div class="shortcut" v-else><span>Ctrl</span><span>Shift</span><span>回车</span></div>
    </div>
    <div class="shortcut-item">
      <div>新窗口</div>
