<template>
  <div class="query-rename-form">
    <form @submit.prevent="submit">
      ...
      <div class="buttons">
        <button class="btn btn-flat" type="button" @click.prevent="$emit('done')">取消</button>
        <button class="btn btn-primary" :disabled="working" type="submit">保存</button>
      </div>
    </form>
  </div>
</template>
